...
`JooseX.Class.SimpleConstructor` is a very simple trait, which makes the `new` keyword optional for instantiation.
The class constructor will just return a new instance every time. This trait should be applied last among all your
traits, modifying the constructor behavior.
